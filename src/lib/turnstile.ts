 ...
 * — production — a missing or invalid token fails.
 *
 * The hostname check is Cloudflare's: a token minted for another site's widget
 * is rejected, so painmanagementer.com must be listed on the Turnstile site.
 */
